const USER_AGENT = 'Kodon/0.1 (https://github.com/ajaxMultiCommentary/kodon) kodon-mini-comp-lib/0.1';
export default async function loadWikidataCollection(collectionID) {
...
function makeQuery(collectionID) {
    return `
